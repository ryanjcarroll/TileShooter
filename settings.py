...
PLAYER_HP = 100
PLAYER_STAMINA = 100
PLAYER_STAMINA_USE = 0.5 # how much stamina to use per frame
PLAYER_STAMINA_REGEN = 0.5 # how much stamina to restore per frame (when active)
PLAYER_STAMINA_REGEN_TIME = 100 # how long after using until stamina regens, in frames
...
SPAWNER_HP = 400
SPAWNER_RANGE = 100
SPAWNER_CAP = 4  # number of enemies per spawn attempt
SPAWNER_RATE = 300
SPAWNER_DELAY = 10
